    ...
    return (
        <div>
            <div className="flex justify-end">
                <h1 className="w-fit text-4xl relative before:absolute before:h-[1px] before:w-[calc(100%)] before:bg-slate-300 before:right-0 before:bottom-[-15px] after:absolute after:w-[40%] after:h-[2px] after:bg-[#725DFE] after:bottom-[-15px] after:right-0">أضافة مشرف</h1>
            </div>
                ...
                <form className="py-5">
                    ...
                    <div className="flex flex-col lg:flex-row-reverse lg:gap-5">
                        <div className="relative flex-1">
                            <select onChange={(e) => setAdminType(e.target.value)}
                                className="w-full border text-right duration-300  text-sm border-[#e2e6f1] special_shadow rounded-md outline-none p-2 my-2  pl-8 pr-3 py-2 transition ease focus:outline-none shadow-sm appearance-none cursor-pointer" defaultValue={''}>
                        ...
                        {adminType !== '' && <div className="relative flex-1">
                        ...
                        {adminType === 'city' && gov !== '' && <div className="relative flex-1">
                            <select
                                className="w-full border text-right duration-300  text-sm border-[#e2e6f1] special_shadow rounded-md outline-none p-2 my-2  pl-8 pr-3 py-2 transition ease focus:outline-none shadow-sm appearance-none cursor-pointer" defaultValue={''}>
                    ...
                    <div className="mt-5">
                        <button type="submit" className="rounded-[0.2rem] duration-300 hover:bg-[#604CC7] text-white bg-[#725DFE] px-4 py-1">اضافة المشرف</button>
                    </div>
                </form>
            </div>
        </div>
