    ...
    return (
        <div>
            <div className="flex justify-end">
                <h1 className="w-fit text-4xl relative before:absolute before:h-[1px] before:w-[calc(100%)] before:bg-slate-300 before:right-0 before:bottom-[-15px] after:absolute after:w-[40%] after:h-[2px] after:bg-[#725DFE] after:bottom-[-15px] after:right-0">أضافة موظف</h1>
            </div>
            <div className="bg-white mt-10 px-2 text-right rounded-sm">
                ...
                <form className="py-5">
                    ...
                    <div className="flex flex-col mb-1 lg:items-end lg:flex-row-reverse lg:gap-5">
