...
export default function AddAdmin() {
    const form = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            nationalId: Yup.number().typeError("هذا الحقل يجب ان يحتوي على ارقام فقط").required('هذا الحقل مطلوب'),
        }),
                    ...
                    <div className="flex-1">
                                <div className="relative">
                                    <select
                                        ...
                                        className={`w-full border text-right duration-300  text-sm border-[#e2e6f1] rounded-md outline-none p-2 my-2  pl-8 pr-3 py-2 transition ease focus:outline-none shadow-sm appearance-none cursor-pointer ${form.errors.adminType && form.touched.adminType ? 'border-red-500' : 'special_shadow'}`}>
                            ...
                            <div className="relative flex-1">
                                <div className="relative">
                                    <select
                                        ...
                                        className={`w-full border text-right duration-300  text-sm border-[#e2e6f1] rounded-md outline-none p-2 my-2  pl-8 pr-3 py-2 transition ease focus:outline-none shadow-sm appearance-none cursor-pointer ${form.errors.gov && form.touched.gov ? 'border-red-500' : 'special_shadow'}`}>
                            ...
                            <div className="relative flex-1">
                                <div className="relative">
                                    <select
                                        ...
                                        className={`w-full border text-right duration-300  text-sm border-[#e2e6f1] rounded-md outline-none p-2 my-2  pl-8 pr-3 py-2 transition ease focus:outline-none shadow-sm appearance-none cursor-pointer ${form.errors.city && form.touched.city ? 'border-red-500' : 'special_shadow'}`}>
