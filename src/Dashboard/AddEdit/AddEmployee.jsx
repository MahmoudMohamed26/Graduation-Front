...
export default function AddEmployee() {
    ...
    const form = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            governorateId: Yup.string().required('هذا الحقل مطلوب'),
            cityId: Yup.string().required('هذا الحقل مطلوب'),
    ...
    return (
        <div>
            ...
            {load ? <div className="mt-10"><Skeleton count={1} className="dark:[--base-color:_#202020_!important] dark:[--highlight-color:_#444_!important]" height={431} width="100%" /></div> : <div className="bg-white mt-10 px-2 text-right rounded-sm dark:border-[#363D3E] dark:bg-[#191A1A]">
