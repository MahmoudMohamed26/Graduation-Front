...
export default function DashSide() {
    ...
    return (
        <div
    className={`fixed md:sticky rounded-lg md:rounded-none bg-white duration-300 top-0 md:top-[74px] z-20 shadow-md w-[270px] h-[100vh] md:h-[calc(100vh-74px)] pt-5 border-l-[1px] border [#e5e5e5] ${menu.isOpen ? 'right-[0px]' : 'right-[-270px]'}`}>
            <div className='ml-5 mb-5 block md:hidden'><RxCross1 onClick={() => menu.setIsOpen((prev) => !prev)} className='cursor-pointer' color='#dc3545' size={25} /></div>
